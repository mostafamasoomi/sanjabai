...
('چت هوشمند', 'دسترسی به جدیدترین مدل‌های هوش مصنوعی برای چت و پاسخگویی', '💬', 1, TRUE, NOW()),
...
('درباره ما', 'ما یک پلتفرم هوش مصنوعی فارسی هستیم که با هدف ارائه بهترین تجربه کاربری و دسترسی به جدیدترین مدل‌های هوش مصنوعی ایجاد شده‌ایم. تیم ما متشکل از متخصصان حوزه فناوری و هوش مصنوعی است که با عشق به زبان فارسی و فرهنگ ایرانی، این پلتفرم را توسعه داده‌اند.', NOW())
...
('socks5://ted:T%23d%40123234@sanjabai_tunnel:9090', 'socks5', TRUE, NOW())
