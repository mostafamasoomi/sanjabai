...
# DEAD: duplicate - admin.py:904 @router.get('/me/usage')
# DEAD: duplicate - admin.py:904 async def get_my_usage(request: Request) -> JSONResponse:
# DEAD: duplicate - admin.py:904     """Auth required: return current balance, monthly usage summary, per-model breakdown, and recent events."""
# DEAD: duplicate - admin.py:904     uid = await _get_user_id(request)
# DEAD: duplicate - admin.py:904     if not uid:
# DEAD: duplicate - admin.py:904         return JSONResponse({'detail': 'لطفاً وارد حساب خود شوید'}, status_code=401)
# DEAD: duplicate - admin.py:904     if async_session is None:
# DEAD: duplicate - admin.py:904         return JSONResponse({'detail': 'پایگاه داده در دسترس نیست'}, status_code=500)
# DEAD: duplicate - admin.py:904 
# DEAD: duplicate - admin.py:904     async with async_session() as session:
# DEAD: duplicate - admin.py:904         # Current balance from ledger
# DEAD: duplicate - admin.py:904         bal_res = await session.execute(
# DEAD: duplicate - admin.py:904             sqlalchemy.text('SELECT COALESCE(SUM(amount), 0) as balance FROM ledger WHERE user_id = :uid'),
# DEAD: duplicate - admin.py:904             {'uid': uid},
# DEAD: duplicate - admin.py:904         )
# DEAD: duplicate - admin.py:904         bal_row = bal_res.fetchone()
# DEAD: duplicate - admin.py:904         current_balance = int(bal_row.balance) if bal_row else 0
# DEAD: duplicate - admin.py:904 
# DEAD: duplicate - admin.py:904         # Month boundaries
# DEAD: duplicate - admin.py:904         now = datetime.now(timezone.utc).replace(tzinfo=None)
# DEAD: duplicate - admin.py:904         month_start = now.replace(day=1, hour=0, minute=0, second=0, microsecond=0)
# DEAD: duplicate - admin.py:904 
# DEAD: duplicate - admin.py:904         # Total spent this month from usage_events
# DEAD: duplicate - admin.py:904         total_res = await session.execute(
# DEAD: duplicate - admin.py:904             sqlalchemy.text(
# DEAD: duplicate - admin.py:904                 "SELECT COALESCE(SUM(charged_amount), 0) as total_spent, "
# DEAD: duplicate - admin.py:904                 "COALESCE(SUM(input_tokens), 0) as total_input, "
# DEAD: duplicate - admin.py:904                 "COALESCE(SUM(output_tokens), 0) as total_output, "
# DEAD: duplicate - admin.py:904                 "COUNT(*) as event_count "
# DEAD: duplicate - admin.py:904                 "FROM usage_events WHERE user_id = :uid AND created_at >= :month_start"
# DEAD: duplicate - admin.py:904             ),
# DEAD: duplicate - admin.py:904             {'uid': uid, 'month_start': month_start},
# DEAD: duplicate - admin.py:904         )
# DEAD: duplicate - admin.py:904         total_row = total_res.fetchone()
# DEAD: duplicate - admin.py:904         total_spent = int(total_row.total_spent) if total_row else 0
# DEAD: duplicate - admin.py:904         total_input = int(total_row.total_input) if total_row else 0
# DEAD: duplicate - admin.py:904         total_output = int(total_row.total_output) if total_row else 0
# DEAD: duplicate - admin.py:904         event_count = int(total_row.event_count) if total_row else 0
# DEAD: duplicate - admin.py:904 
# DEAD: duplicate - admin.py:904         # Per-model breakdown this month
# DEAD: duplicate - admin.py:904         breakdown_res = await session.execute(
# DEAD: duplicate - admin.py:904             sqlalchemy.text(
# DEAD: duplicate - admin.py:904                 "SELECT model, "
# DEAD: duplicate - admin.py:904                 "COALESCE(SUM(input_tokens), 0) as input_tokens, "
# DEAD: duplicate - admin.py:904                 "COALESCE(SUM(output_tokens), 0) as output_tokens, "
# DEAD: duplicate - admin.py:904                 "COALESCE(SUM(charged_amount), 0) as cost, "
# DEAD: duplicate - admin.py:904                 "COUNT(*) as calls "
# DEAD: duplicate - admin.py:904                 "FROM usage_events WHERE user_id = :uid AND created_at >= :month_start "
# DEAD: duplicate - admin.py:904                 "GROUP BY model ORDER BY cost DESC"
# DEAD: duplicate - admin.py:904             ),
# DEAD: duplicate - admin.py:904             {'uid': uid, 'month_start': month_start},
# DEAD: duplicate - admin.py:904         )
# DEAD: duplicate - admin.py:904         per_model = []
# DEAD: duplicate - admin.py:904         for row in breakdown_res.fetchall():
# DEAD: duplicate - admin.py:904             per_model.append({
# DEAD: duplicate - admin.py:904                 'model': row.model,
# DEAD: duplicate - admin.py:904                 'input_tokens': int(row.input_tokens),
# DEAD: duplicate - admin.py:904                 'output_tokens': int(row.output_tokens),
# DEAD: duplicate - admin.py:904                 'cost': int(row.cost),
# DEAD: duplicate - admin.py:904                 'calls': int(row.calls),
# DEAD: duplicate - admin.py:904             })
# DEAD: duplicate - admin.py:904 
# DEAD: duplicate - admin.py:904         # Recent events (last 50)
# DEAD: duplicate - admin.py:904         events_res = await session.execute(
# DEAD: duplicate - admin.py:904             sqlalchemy.text(
# DEAD: duplicate - admin.py:904                 "SELECT id, model, input_tokens, output_tokens, charged_amount, created_at "
# DEAD: duplicate - admin.py:904                 "FROM usage_events WHERE user_id = :uid "
# DEAD: duplicate - admin.py:904                 "ORDER BY created_at DESC LIMIT 50"
# DEAD: duplicate - admin.py:904             ),
# DEAD: duplicate - admin.py:904             {'uid': uid},
# DEAD: duplicate - admin.py:904         )
# DEAD: duplicate - admin.py:904         recent_events = []
# DEAD: duplicate - admin.py:904         for row in events_res.fetchall():
# DEAD: duplicate - admin.py:904             recent_events.append({
# DEAD: duplicate - admin.py:904                 'id': row.id,
# DEAD: duplicate - admin.py:904                 'model': row.model,
# DEAD: duplicate - admin.py:904                 'input_tokens': int(row.input_tokens),
# DEAD: duplicate - admin.py:904                 'output_tokens': int(row.output_tokens),
# DEAD: duplicate - admin.py:904                 'cost': int(row.charged_amount),
# DEAD: duplicate - admin.py:904                 'created_at': row.created_at.isoformat() if row.created_at else None,
# DEAD: duplicate - admin.py:904             })
# DEAD: duplicate - admin.py:904 
# DEAD: duplicate - admin.py:904     return JSONResponse(jsonable_encoder({
# DEAD: duplicate - admin.py:904         'current_balance': current_balance,
# DEAD: duplicate - admin.py:904         'total_spent_this_month': total_spent,
# DEAD: duplicate - admin.py:904         'total_input_tokens_this_month': total_input,
# DEAD: duplicate - admin.py:904         'total_output_tokens_this_month': total_output,
# DEAD: duplicate - admin.py:904         'event_count_this_month': event_count,
# DEAD: duplicate - admin.py:904         'per_model_breakdown': per_model,
# DEAD: duplicate - admin.py:904         'recent_events': recent_events,
    }))
