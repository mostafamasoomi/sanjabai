...
FORBIDDEN = [
    (r'۹۹\.۹', 'uptime percentage is unverified'),
    (r'99\.9', 'uptime percentage is unverified'),
    ...
    (r'۱۰,۰۰۰', 'gift amount must come from a grant record'),
    (r'۱۰٬۰۰۰', 'gift amount must come from a grant record'),
    (r'۱۰۰۰۰', 'gift amount must come from a grant record'),
