"""
Multiai Telegram Bot — AI chat + wallet + account linking.
...
async def api_request(method: str, path: str, token: str = '', json_data: dict = None) -> dict:
    """Make authenticated API request to Multiai backend"""
...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if token:
        ...
        await update.message.reply_text(
            ...
            '1️⃣ در سایت [multiai.ir](https://multiai.ir) ثبت‌نام کنید\n'
...
async def cmd_wallet(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f'برای شارژ حساب به [multiai.ir/wallet](https://multiai.ir/wallet) مراجعه کنید.',
        parse_mode=ParseMode.MARKDOWN,
        disable_web_page_preview=True,
    )
