...
const FA = {
  notFoundTitle: 'مهارت یافت نشد',
  notFoundDesc: 'مهارت مورد نظر وجود ندارد یا حذف شده است.',
  backToMarketplace: 'بازگشت به مارکتپلیس',
  featuredBadge: 'ویژه',
  reviewsCount: (n: string) => `(${n} نظر)`,
  usageCount: (n: string) => `${n} استفاده`,
  shareAction: 'اشتراک‌گذاری',
  notAuthText: 'برای استفاده از این مهارت، ابتدا وارد حساب کاربری خود شوید.',
  signInAction: 'ورود به حساب',
  runSkillHeading: 'اجرای مهارت',
  modelLabel: 'مدل',
